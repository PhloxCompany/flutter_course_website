...
import 'package:flutter_course_phlox/controller/providers/test_request.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (context) => LoginAndEnterCodeProvider(),
        ),
        ChangeNotifierProvider(
          create: (context) => TestRequestProvider(context),
        ),
      ],
      child: const _MyApp(),
    );
